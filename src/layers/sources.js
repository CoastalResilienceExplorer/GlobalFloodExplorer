...
const flooding_1996 = {
  type: "raster",
  tiles: [
    `${COGSERVER_URL}/{z}/{x}/{y}.png?dataset=cwon_data/with_1996_TC_Tr_${RP}.tiff&max_val=8&color=blues`,
  ],
  tileSize: 256,
};
...
const flooding_2015 = {
  type: "raster",
  tiles: [
    `${COGSERVER_URL}/{z}/{x}/{y}.png?dataset=cwon_data/with_2015_TC_Tr_${RP}.tiff&max_val=8&color=blues`,
  ],
  tileSize: 256,
};
...
const CWON_tesela_reppts = {
  ...
  format: "mvt",
  tiles: [
    `${PMSERVER_URL}/vectors/CWON_combined_teselas_reppts/{z}/{x}/{y}.mvt`,
  ],
  minzoom: 0,
  maxzoom: 14,
};
...
const CWON_tesela_bounds = {
  ...
  type: "vector",
  format: "mvt",
  tiles: [`${PMSERVER_URL}/vectors/CWON_combined_teselas/{z}/{x}/{y}.mvt`],
  minzoom: 0,
  maxzoom: 14,
};
...
const CWON_tesela_hexs = {
  ...
  type: "vector",
  format: "mvt",
  tiles: [`${PMSERVER_URL}/vectors/CWON_combined_teselas_hexs/{z}/{x}/{y}.mvt`],
  minzoom: 0,
  maxzoom: 14,
};
